...
export function About() {
  ...
  return (
    <section className="relative flex flex-col items-center md:pt-56 overflow-hidden min-h-screen">
      ...
      <div className=" px-4 relative z-10 pb-16">
      ...
      <div className="relative flex w-full justify-center sm:justify-start">
        ...
        <div className="relative z-10 p-8 ">
          <h3 className="text-3xl md:text-6xl font-bold tracking-tighter leading-tight uppercase text-(--color-brand-yellow) text-center sm:text-left">
            {t("tagline1")}
          </h3>
          <h3 className="text-3xl md:text-6xl font-light italic tracking-tighter text-(--foreground) leading-tight uppercase text-center sm:text-left">
            {t("tagline2")}
          </h3>
        ...
        <div className="flex items-center gap-6 pt-16">
          ...
          <Link 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border p-4 rounded-full active:scale-95 hover:scale-105 transition-transform smooth "
          >
            <Image

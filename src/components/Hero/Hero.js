...
const Hero = () => {
  return (
    <section className="hero overflow-hidden bg-white py-16 dark:bg-[#121212] transition-colors duration-300">
      <div className="hero-container relative mx-auto flex max-w-[1200px] flex-col items-center justify-between px-5 md:flex-row md:text-left text-center">
        ...
        <div className="hero-content relative z-10 flex-1 min-w-[300px] md:pl-8 pl-0">
          <div className="yellow-gradient-bg pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[120%] w-[120%] max-w-[800px] -translate-x-1/2 -translate-y-1/2 blur-[40px] opacity-100 dark:opacity-40" style={{
          ...
          <h1 className="mb-2 text-[3.5rem] font-extrabold leading-[1.1] text-[#1a1a1a] dark:text-white">Clubhouse,<br />but Open Source</h1>
          <h2 className="mb-4 text-[2.5rem] font-normal text-[#1a1a1a] dark:text-gray-200">A social voice platform.</h2>
          <p className="maintained-by mb-8 text-[1.1rem] text-[#666] dark:text-gray-400">A Project Maintained by <a href="https://aossie.org" className="aossie-link text-[#666] underline dark:text-[#FFC107]">AOSSIE</a></p>
      ...
      <div className="hero-description-container mx-auto mt-16 max-w-[900px] px-5 text-center">
        <p className="text-[1.1rem] leading-[1.8] text-[#333] dark:text-gray-300">
